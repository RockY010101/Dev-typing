// Lofi Playlist Configuration
// You can add, edit, or remove tracks from this list.
// To use local MP3 files, place them in the 'client/public/music/' folder
// and set src: '/music/your-song.mp3'
